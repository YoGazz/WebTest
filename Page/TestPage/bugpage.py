...
class BugPage(BasePage):
    ...
    bug_ele = (By.XPATH,'//*[@id="modulemenu"]/ul/li[4]/a')
    submitbug_ele = (By.CSS_SELECTOR,'.btn btn-primary')
    ...
    content_ele = (By.XPATH,'//*[@id="bugList"]/tbody/tr/td[4]/a')

    def submit_bug(self,titel,content):
    ...
    def submitbug_result(self,content):
        try:
            r = self.find(self.content_ele).text
            assert r == content
            return content
        except:
            return False
